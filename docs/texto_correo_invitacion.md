# Texto base para envío por correo
...
```text
Antes de enviar masivamente, verificar que el backend Apps Script esté público y que la sincronización contra Google Sheets funcione en una prueba real de punta a punta.
```
